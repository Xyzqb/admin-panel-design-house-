            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white font-medium hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95"
                >
                  <Plus size={20} />
            ...
            <table className="w-full min-w-[1000px]">
              <thead className="bg-gradient-to-r from-gray-100 via-gray-50 to-gray-100 border-b-2 border-gray-200">
                <tr>
                  ...
                  <th className="p-5 text-left text-sm font-bold text-gray-900 uppercase tracking-wide">Details</th>
                    ...
                    >
                      ...
                      <td className="p-5">
                        <div className="space-y-1">
                          <div className="font-bold text-emerald-600">{project.budget}</div>
                          <div className="text-sm text-gray-600">{project.location}</div>
                          <div className="text-xs text-gray-500">{project.teamSize} team members</div>
